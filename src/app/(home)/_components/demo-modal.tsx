// components/ui-elements/DemoEnvironmentModal.tsx
"use client";

import { Dialog, Transition } from "@headlessui/react";
import { Fragment, useEffect, useState } from "react";

export function DemoEnvironmentModal() {
  const [isOpen, setIsOpen] = useState(false);

  useEffect(() => {
    if (typeof window === "undefined") return;
  
    const alreadyShown = sessionStorage.getItem("demoModalShown");
            ...
            >
              <Dialog.Panel className="w-full max-w-sm transform overflow-hidden rounded-2xl bg-white p-6 text-center align-middle shadow-xl transition-all">
                ...
                <div className="mt-2">
                  ...
                  <p className="mt-6 text-sm text-gray-700 bold">
                    SOLANA BREAKOUT HACKATHON ❤️
                  </p>
                </div>
              </Dialog.Panel>
            </Transition.Child>
